...
export const FRAME_THEMES: FrameTheme[] = [
  {
    id: 'pink_lattice_hearts',
    name: 'Lưới Trái Tim Hồng Y2K 💕',
    category: 'cute',
    description: 'Khung lưới kẽm hồng Y2K: 4 ô ảnh viền đen, hoạ tiết trái tim đỏ ngọt ngào, dây xoắn doodle, đốm xéo lattice & trái tim mây hồng',
    badgeText: 'PINK LATTICE 💕',
    fontFamily: "'Quicksand', 'Plus Jakarta Sans', sans-serif",
    accentColor: '#FF3575',
    borderStyle: 'solid',
    defaultTextColor: '#FF3575',
    topDecoration: '💕 PINK LATTICE • HEARTS 💕',
    bottomDecoration: 'love you so much ♡',
    isSpecialArtwork: true,
    isImageOverlay: true,
    hasFixedColor: true,
    fixedColorId: 'pink_lattice_pastel',
  },
  {
    id: 'happy_with_you',
    name: 'Happy With You (Botanical Clouds) 🌿',
    category: 'cute',
    description: 'Khung mộng mơ thảo mộc: 4 ô ảnh cắt bo tròn, mây trời pastel, cành lá vẽ nét thanh mảnh, ngôi sao lấp lánh & chữ happy with you',
    badgeText: 'HAPPY WITH YOU 🌿',
    fontFamily: "'Quicksand', 'Plus Jakarta Sans', sans-serif",
    accentColor: '#56412D',
    borderStyle: 'solid',
    defaultTextColor: '#56412D',
    topDecoration: '@reallygreatsite • happy with you',
    bottomDecoration: 'happy with you • sweet moments',
    isSpecialArtwork: true,
    isImageOverlay: true,
    hasFixedColor: true,
    fixedColorId: 'happy_nature_cream',
  },
  {
    id: 'grunge_sulfus',
    name: 'Grunge 7:77 Sulfus Đen 🖤',
    category: 'y2k',
    description: 'Khung đen cá tính: 3 vệt băng keo dán góc, trái tim doodle, vệt cọ sơn trắng Grunge 7:77 & chữ ký sulfus',
    badgeText: 'GRUNGE 7:77 🖤',
    fontFamily: "'Courier New', monospace, sans-serif",
    accentColor: '#FFFFFF',
    borderStyle: 'solid',
    defaultTextColor: '#FFFFFF',
    topDecoration: '◀ 7 ▶ • SULFUS • ◀ 0 ▶',
    bottomDecoration: '7:77 • sulfus',
    isSpecialArtwork: true,
    isImageOverlay: true,
    hasFixedColor: true,
    fixedColorId: 'grunge_pitch_black',
  },
  {
    id: 'airmail_postcard',
...
export const FRAME_COLORS: FrameColor[] = [
  {
    id: 'pink_lattice_pastel',
    name: 'Hồng Lưới Trái Tim Y2K 💕',
    hex: '#FFB2C3',
    textColor: '#FF3575',
    subtextColor: '#52424E',
    borderHex: '#FF84A2',
  ...
  {
    id: 'happy_nature_cream',
    name: 'Kem Thảo Mộc (Happy With You) 🌿',
    hex: '#F7F4EB',
    textColor: '#56412D',
    subtextColor: '#8B735B',
    borderHex: '#E2E9CB',
  ...
  {
    id: 'grunge_pitch_black',
    name: 'Đen Tuyền Grunge 7:77 🖤',
    hex: '#0D0D0D',
    textColor: '#FFFFFF',
    subtextColor: '#E5E7EB',
    borderHex: '#262626',
